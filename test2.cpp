...
/*
An integer whose base-ten representation consists only of zero and one is called
a  "zero-one".

 

Given an arbitrary integer N, find the string S that
represents smallest positive "zero-one"  integer which is a multiple of N.  (It
is mathematically guaranteed that every N has at least one S).
