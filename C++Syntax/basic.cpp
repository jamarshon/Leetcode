...
vector<int> third (first.begin() + 1,first.end());  // 4 3 as it is copying values from first
...
// generate elements based on a function (3 is the number of elements it can be more than the
// size of the array)
#include <algorithm>
int current = 0;
